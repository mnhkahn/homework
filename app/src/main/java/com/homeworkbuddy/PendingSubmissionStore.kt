...
data class PendingSubmission(val taskId: String, val photoPaths: List<String>, val isOvertime: Boolean, val submissionId: String = UUID.randomUUID().toString(), val completionOnly: Boolean = false, val textContent: String? = null)
